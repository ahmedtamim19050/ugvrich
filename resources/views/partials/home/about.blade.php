    ...
    <div class="container-rich grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
        ...
        <div>
            <x-section-heading
                ...
                title='Research, Innovation &amp; <span class="text-accent">Consultation Hub</span>' />
            ...
            <ul class="reveal mt-8 flex flex-wrap gap-2" style="transition-delay: 160ms">
                @foreach ([['beaker', 'Research'], ['lightbulb', 'Innovation'], ['briefcase', 'Industry services'], ['rocket', 'Entrepreneurship']] as [$icon, $label])
        ...
        <div class="grid gap-5">
            ...
            <div class="reveal group relative isolate overflow-hidden rounded-[2rem] p-8 sm:p-10">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-[12px] font-semibold uppercase tracking-[0.2em] text-brand-200">Our vision</p>
                </div>
            ...
            <div class="reveal relative overflow-hidden rounded-[2rem] border border-brand-100 bg-brand-50 p-8 sm:p-10" style="transition-delay: 120ms">
                ...
                <div class="relative flex items-center gap-3">
                    ...
                    <p class="text-[12px] font-semibold uppercase tracking-[0.2em] text-brand-700">Our mission</p>
                </div>
